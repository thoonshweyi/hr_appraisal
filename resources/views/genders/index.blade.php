...
<div class="content-page">
    <div class="container-fluid">
        <div class="row">
            ...
            {{-- <div class="col-lg-12">
                <form class="d-inline" action="{{ route('genders.excel_import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        <form id="{{route('genders.store')}}" action="" method="POST">
                            {{ csrf_field() }}
                            <div class="row align-items-end">
                                <div class="col-md-12">
