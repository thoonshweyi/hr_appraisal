...
class SourcingDocument extends Model
{
    use HasFactory;
    protected $fillable = [
        'document_type',
        ...
        'sourcing_id',
        'sourcing_updated_datetime',
        'sourcing_attach_file',
        'sourcing_remark',
        'accounting_id',
        ...
        'excel_attach_file',
        'sourcing_reject_remark_id',
        'sourcing_reject_remark_updated_datetime',
        'issue_doc_datetime',
        'account_issued_id',
    ...
    {
        return $this->hasMany(SourcingProduct::class, 'document_id', 'id');
    }
    ...
    public function sourcingproduct(){
        return $this->hasMany('App\Models\SourcingProduct','document_id','id');
    }
}
